...
class ClassificationTrainerRAG1():
    ...
    def generate_RAG_mapping(self, global_vec, global_labels, model, comms):
        ...
        torch.save(self.mappings, f"./ckpts/gptf/{self.dataname}_map_{self.client_id}.pth")
        ...
        torch.save(self.mappings1, f"./ckpts/gptf/{self.dataname}_maptest_{self.client_id}.pth")
    ...
    def run(self, comms, img_vec, txt_vec, labels, idxs, gmodel):
        ...
        torch.save(model, f"./ckpts/TmpMAVG1/{self.args.prefix}_{self.client_id}.pth") 
